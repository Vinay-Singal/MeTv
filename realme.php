    ...
    <div class="slider-container">
        <div class="slider">
            <div class="slide">
                ...
                <img src="realme slider1.png" alt="Slide 1">
            </div>
            <div class="slide">
                <img src="realme slider2.png" alt="Slide 2">
            </div>
            <div class="slide">
                <img src="realme slider3.png" alt="Slide 3">
            </div>
            <div class="slide">
                <img src="realme slider4.png" alt="Slide 4">
            </div>
        </div>
    </div>
    <h1 style="text-align: center; background-color: rgb(255, 200, 22); color: #FFFF;">
    <center><img src="realme logo1.png"  width="280"alt="REALME" style="vertical-align: middle;"></h1><center>
    <div class="container">
        <div class="row">

    <?php
    $query = "SELECT * FROM `product` WHERE `category`='REALME'";
