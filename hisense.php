    ...
    <div class="slider-container">
        <div class="slider">
            <div class="slide">
                ...
                <img src="hisense slider1.png" alt="Slide 1">
            </div>
            <div class="slide">
                <img src="hisense slider3.png" alt="Slide 2">
            </div>
            <div class="slide">
                <img src="hisense slider2.png" alt="Slide 3">
            </div>
            <div class="slide">
                <img src="hisense slider4.png" alt="Slide 4">
            </div>
        </div>
    </div>
    <h1 style="text-align: center; background-color: ; color: #df0539;">
       <center> <img src="hisense logo.png" alt="HISENSE" style="vertical-align: middle;"></h1></center>
    <div class="container">
        <div class="row">

    <?php
    $query = "SELECT * FROM `product` WHERE `category`='HISENSE'";
