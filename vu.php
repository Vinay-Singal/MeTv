    ...
    <div class="slider-container">
        <div class="slider">
            <div class="slide">
                ...
                <img src="vu slider4.png" alt="Slide 1">
            </div>
            <div class="slide">
                <img src="vu slider3.png" alt="Slide 2">
            </div>
            <div class="slide">
                <img src="vu slider2.png" alt="Slide 3">
            </div>
            <div class="slide">
                <img src="vu slider1.png" alt="Slide 4">
            </div>
        </div>
    </div>
    <h1 style="text-align: center; background-color: rgb(5, 5, 5); color: #FFFF;">
    <center><img src="vu logo.png" alt="VU" style="vertical-align: middle;"></h1><center>
    <div class="container">
        <div class="row">

    <?php
    $query = "SELECT * FROM `product` WHERE `category`='VU'";
