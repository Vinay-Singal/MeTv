    ...
    <div class="slider-container">
        <div class="slider">
            <div class="slide">
                ...
                <img src="sony slider1.png" alt="Slide 1">
            </div>
            <div class="slide">
                <img src="sony slider2.png" alt="Slide 2">
            </div>
            <div class="slide">
                <img src="sony slider3.png" alt="Slide 3">
            </div>
            <div class="slide">
                <img src="sony slider4.png" alt="Slide 4">
            </div>
        </div>
    </div>
    <h1 style="text-align: center; background-color: ; color: #070707; font-size: 80px" >
    <center>SONY</h1><center>
    <div class="container">
        <div class="row">

    <?php
    $query = "SELECT * FROM `product` WHERE `category`='SONY'";
