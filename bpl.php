    ...
    <div class="slider-container">
        <div class="slider">
            <div class="slide">
                ...
                <img src="bpl slider4.png" alt="Slide 1">
            </div>
            <div class="slide">
                <img src="bpl slider5.png" alt="Slide 2">
            </div>
            <div class="slide">
                <img src="bpl slider3.png" alt="Slide 3">
            </div>
            <div class="slide">
                <img src="bpl slider1.png" alt="Slide 4">
            </div>
        </div>
    </div>
    <h1 style="text-align: center; background-color: rgb(42, 171, 226); color: #FFFF;">
    <center><img src="bpl logo1.png" width="290" height="80" alt="BPL" style="vertical-align: middle;"></h1><center>
    <div class="container">
        <div class="row">

    <?php
    $query = "SELECT * FROM `product` WHERE `category`='BPL'";
