    ...
    <div class="slider-container">
        <div class="slider">
            <div class="slide">
                ...
                <img src="lg slider3.png" alt="Slide 1">
            </div>
            <div class="slide">
                <img src="lg slider2.png" alt="Slide 2">
                </div>
                <div class="slide">
                    <img src="lg slider4.png" alt="Slide 3">
                </div>
                <div class="slide">
                    <img src="lg slider5.png" alt="Slide 4">
                </div>
            </div>
        </div>
        <h1 style="text-align: center; background-color: ; color: #df0539;">
        <img src="lg logo2.png" alt="LG" style="vertical-align: middle;">   LG</h1>
        <div class="container">
  <div class="row">

    <?php
    $query = "SELECT * FROM `product` WHERE `category`='lg'";
