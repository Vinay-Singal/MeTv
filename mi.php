    ...
    <div class="slider-container">
        <div class="slider">
            <div class="slide">
                ...
                <img src="mi slider1.png" alt="Slide 1">
            </div>
            <div class="slide">
                <img src="mi slider2.png" alt="Slide 2">
            </div>
            <div class="slide">
                <img src="mi slider5.png" alt="Slide 3">
            </div>
            <div class="slide">
                <img src="mi slider4.png" alt="Slide 4">
            </div>
        </div>
    </div>
    <h1 style="text-align: center; background-color: rgb(242, 121, 32); color: #FFFF;">
    <center><img src="mi logo.png" alt="MI" style="vertical-align: middle;"></h1><center>
    <div class="container">
        <div class="row">

    <?php
    $query = "SELECT * FROM `product` WHERE `category`='MI'";
