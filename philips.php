    ...
    <div class="slider-container">
        <div class="slider">
            <div class="slide">
                ...
                <img src="philips slider1.png" alt="Slide 1">
            </div>
            <div class="slide">
                <img src="philips slider2.png" alt="Slide 2">
            </div>
            <div class="slide">
                <img src="philips slider3.png" alt="Slide 3">
            </div>
            <div class="slide">
                <img src="philips slider4.png" alt="Slide 4">
            </div>
        </div>
    </div>
    <h1 style="text-align: center; background-color: white; color: #FFFF;">
    <center><img src="philips logo1.png" width="290" height="80" alt="PHILIPS" style="vertical-align: middle;"></h1><center>
    <div class="container">
        <div class="row">

    <?php
    $query = "SELECT * FROM `product` WHERE `category`='PHILIPS'";
