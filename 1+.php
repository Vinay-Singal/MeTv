    ...
    <div class="slider-container">
        <div class="slider">
            <div class="slide">
                ...
                <img src="1+slider1.png" alt="Slide 1">
            </div>
            <div class="slide">
                <img src="1+slider2.png" alt="Slide 2">
            </div>
            <div class="slide">
                <img src="1+slider3.png" alt="Slide 3">
            </div>
            <div class="slide">
                <img src="1+slider4.png" alt="Slide 4">
            </div>
        </div>
    </div>
    <h1 style="text-align: center; background-color: ; color: #FFFF;">
    <center><img src="1+1logo.png" alt="LG" style="vertical-align: middle;"></h1><center>
    <div class="container">
        <div class="row">
